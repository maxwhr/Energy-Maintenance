...
from app.services.citation_validation_service import CitationValidationResult, CitationValidationService
...
def test_citation_scope_validation_contract():
    ...
    assert "missing_pdf_page_or_section_locator" in source
